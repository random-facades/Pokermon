...
local smeargle={
  ...
  draw = function(self, card, layer)
    ...
    if not card.children.center.video then
      ...
      card.children.center.video = love.graphics.newCanvas(12*71, 12*95)
...
smeargle.easle = love.graphics.newImage(SMODS.current_mod.path:match("Mods/[^/]+")..'/assets/1x/easel.png')
-- Tyrogue 236
local tyrogue={
  name = "tyrogue",
