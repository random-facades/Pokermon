...
-- This is the spanish file!
-- I remember taking spanish classes, maybe I should have been paying more attention...
...
return {
    ...
    misc = {
        ...
        dictionary = {
            ...
            poke_settings_jokers_only = "Jokers only? (Requires restart)",
            poke_settings_no_evolutions = "No Evolutions? (Requires restart)",
            poke_settings_pokeballs = "Pokéballs? (Requires restart)",
            poke_settings_pokedex_number = "Pokedex Numbers? (Requires restart)",
            poke_settings_pokemon_splash = "Pokémon Splash Card? (Requires restart)",
